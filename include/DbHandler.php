<?php
 ...
 //Clase que maneja las acciones en la base de datos
class DbHandler {
    ...
    public function createUser($name, $email, $password) {
        ...
        if (!$this->isUserExists($email)) {
            // Aqui genereamos la password con el hash
            $password_hash = PassHash::hash($password);

            // Generacion de la ApiKey
            ...
            // Comprobacion de que el usuario se ha insertado correctamente
            if ($result) {
            ...
            // Nos muestra este error si el email ya existe en la Base de Datos
